---
description: Performs a senior-developer level adversarial code review on uncommitted changes.
---

# Adversarial Code Review

Do a `git diff` on the uncommitted changes and pretend you are a **senior developer doing a code review who HATES this implementation**.
